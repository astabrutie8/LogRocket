...
#[derive(Debug)]
pub struct LogRocketProcessor {
    verbose: bool,
    processed_count: usize,
}

impl LogRocketProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting LogRocket processing");
    
    let mut processor = LogRocketProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = LogRocketProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = LogRocketProcessor::new(false);
